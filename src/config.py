"""
config.py -- Central configuration for Scholar Stream.

All hyperparameters, paths, and model choices live here.
Every other script imports from this file — never hardcode values elsewhere.
"""
...
for _d in [PAPERS_DIR, PARSED_DIR, INDEX_DIR, EVAL_DIR, RESULTS_DIR]:
...
# ── Chunking strategies (ablation study) ──────────────────────────────────────
CHUNK_CONFIGS = {
...
# ── Embedding models (ablation study) ─────────────────────────────────────────
EMBEDDING_MODELS = {
